...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pincode = new QLineEdit(groupBox);
        pincode->setObjectName("pincode");
        pincode->setEchoMode(QLineEdit::Password);

        horizontalLayout_2->addWidget(pincode);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_pin->setText(QCoreApplication::translate("MainWindow", "\320\237\320\270\320\275-\320\272\320\276\320\264", nullptr));
        pincode->setText(QString());
